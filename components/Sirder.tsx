...
const Sider = () => {
  return (
    <div>
      ...
      <p className="justify-center px-3 py-2 my-5 bg-gray-200 rounded-full">
        Front-end, React.js / Next.js
      </p>
      <a
        className="flex items-center justify-center px-3 py-2 my-5 bg-gray-200 rounded-full"
        href=""
        download="name"
      >
      ...
      <div
        className="py-3 my-5 bg-gray-200"
